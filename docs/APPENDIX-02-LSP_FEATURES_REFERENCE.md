...
- **Full Guide**: See `APPENDIX-01-DEVELOPMENT_GUIDE.md` for detailed explanations and examples
...
3. **Use examples**: Copy from `APPENDIX-01-DEVELOPMENT_GUIDE.md` examples
